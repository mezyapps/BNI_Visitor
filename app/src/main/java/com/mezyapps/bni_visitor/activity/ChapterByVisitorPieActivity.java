...
public class ChapterByVisitorPieActivity extends AppCompatActivity {
    ...
    String chapter_id,chapter_name;
    private String not_interested="0",member="0",follow_up="0";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_chapter_by_visitor_pie);
    ...
    private void find_View_IDs() {
        ...
        showProgressDialog=new ShowProgressDialog(ChapterByVisitorPieActivity.this);

        Bundle bundle = getIntent().getExtras();
        if (bundle != null) {
            chapter_id = bundle.getString("chapter");
            chapter_name = bundle.getString("chapter_name");
            text_title_name.setText(chapter_name);
        }

        if (NetworkUtils.isNetworkAvailable(ChapterByVisitorPieActivity.this)) {
            callPieChartCount();
        }
        else {
            NetworkUtils.isNetworkNotAvailable(ChapterByVisitorPieActivity.this);
        }
    ...
    private void events() {
        ...
        pieChart_visitor.setOnChartValueSelectedListener( new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, int dataSetIndex, Highlight h) {
                ...
                {
                    Intent intent=new Intent(ChapterByVisitorPieActivity.this,VisitorListByChapterDisplayActivity.class);
                    intent.putExtra("status","2");
                    intent.putExtra("chapter",chapter_id);
    ...
    private void callPieChartCount() {
        ...
        Call<SuccessModel> call = apiInterface.chapterPieCount(chapter_id);
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (successModule != null) {
                            ...
                            Toast.makeText(ChapterByVisitorPieActivity.this, "Response Null", Toast.LENGTH_SHORT).show();
                            showProgressDialog.dismissDialog();
                        }
                    }
