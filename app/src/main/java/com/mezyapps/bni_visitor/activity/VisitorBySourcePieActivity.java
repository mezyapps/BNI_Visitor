...
public class VisitorBySourcePieActivity extends AppCompatActivity {
    ...
    private void find_View_IDs() {
        ...
        showProgressDialog = new ShowProgressDialog(VisitorBySourcePieActivity.this);

        Bundle bundle = getIntent().getExtras();
        if (bundle != null) {
            source = bundle.getString("source");
            text_title_name.setText(source);
        }

        if (NetworkUtils.isNetworkAvailable(VisitorBySourcePieActivity.this)) {
            callPieChartCount();
        } else {
            NetworkUtils.isNetworkNotAvailable(VisitorBySourcePieActivity.this);
        }
        ...
        pieChart_visitor.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, int dataSetIndex, Highlight h) {
                ...
                if (value.equalsIgnoreCase("Not Interested")) {
                    Intent intent = new Intent(VisitorBySourcePieActivity.this, VisitorBySourceListActivity.class);
    ...
    private void pieChartSet() {
        ...
        colors.add(getResources().getColor(R.color.source_member));
        colors.add(getResources().getColor(R.color.source_follow_up));
        colors.add(getResources().getColor(R.color.source_not_interested));
    ...
    private void callPieChartCount() {
        ...
        Call<SuccessModel> call = apiInterface.sourcePieCount(source);
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (successModule != null) {
                            ...
                            Toast.makeText(VisitorBySourcePieActivity.this, "Response Null", Toast.LENGTH_SHORT).show();
                            showProgressDialog.dismissDialog();
                        }
                    }
